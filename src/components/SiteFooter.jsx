const linkGroups = [
  ...
  { label: "YouTube Metrics", href: "#/metrics" },
  ...
  },
  {
    ...
    links: [
      { label: "Regia", href: "#/admin" },
      { label: "Presenze", href: "#/visitatori" },
      { label: "Diario interno", href: "#/log-admin" },
      { label: "Statistiche", href: "#/log-stats" },
      { label: "Spazio speciale", href: "#/quantum" },
    ],
  },
  {
    title: "Fiducia",
