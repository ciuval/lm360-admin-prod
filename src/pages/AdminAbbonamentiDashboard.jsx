...
// âœ… File: src/pages/AdminAbbonamentiDashboard.jsx
...
export default function AdminAbbonamentiDashboard() {
  ...
  const listaFiltrata = lista.filter((a) => {
    ...
    const matchNome = filtroNome
      ? a.profili?.nome?.toLowerCase().includes(filtroNome.toLowerCase())
      : true;
  ...
  return (
    <div style={{ padding: '2rem', color: '#fff', fontFamily: 'monospace' }}>
      <h2 style={{ color: '#f08fc0' }}>ðŸ“Š Dashboard Abbonamenti (Admin)</h2>
      ...
      <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginBottom: '1rem' }}>
        ...
        <input
          ...
          style={selectStyle}
        />
        <button onClick={esportaCSV} style={buttonStyle}>
          â¬‡ï¸ Esporta CSV
        </button>
      </div>

      <h4>ðŸ“ˆ Abbonamenti per mese</h4>
      ...
      <h4 style={{ marginTop: '2rem' }}>ðŸ“‹ Lista filtrata</h4>
      <table
        style={{
          width: '100%',
          marginTop: '1rem',
