...
export default function VideoPage({ userId }) {
  ...
  return (
    <div style={shell}>
      <aside style={left}>
        <div style={{ fontWeight: 700, marginBottom: 10, color: '#f08fc0' }}>ðŸŽžï¸ Video</div>
      ...
      <main style={main}>
        <div style={card}>
          ...
          <h3 style={{ margin: 0 }}>ðŸ“º Feed Video</h3>
          <p style={{ opacity: 0.8, marginTop: 8 }}>
            Segnaposto: qui aggiungeremo player, lista video, like/commenti.
          </p>
        </div>
      </main>
    </div>
