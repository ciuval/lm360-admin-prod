...
export default function SetupMFA() {
  ...
  const verificaCodice = async () => {
    ...
    if (error) {
      ...
      toast.success('âœ… MFA attivato con successo');
      navigate('/profilo');
    }
  };
  ...
  return (
    <div style={container}>
      ...
      <h2 style={title}>ðŸ” Configura MFA</h2>

      {loading ? (
        <p style={{ marginTop: '2rem' }}>â³ Caricamento codice QR...</p>
      ) : error ? (
        <>
        ...
        <>
          ...
          <input
            ...
            style={input}
          />
          <button onClick={verificaCodice} style={btn}>
            Verifica Codice
          </button>
        </>
      )}
