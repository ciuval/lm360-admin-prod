const pageData = {
  ...
  visitatori: {
    eyebrow: "Visitatori",
    title: "Gestione visitatori e stati account.",
    lead: "Area owner/admin per organizzare stati, controlli e procedure sui visitatori. Non legge dati live e non modifica account dal browser.",
    cards: [
      { label: "Stati", title: "Attivo, review, sospeso", text: "Gli stati dei visitatori si cambiano solo con blocchi SQL controllati o funzioni server-side future.", actions: [{ label: "Manuale admin", href: "#/admin" }] },
      { label: "Supabase", title: "Procedure con preflight", text: "Per modifiche reali si prepara un comando dedicato: audit, conferma esplicita, esecuzione, postcheck.", actions: [{ label: "Sicurezza", href: "#/sicurezza" }] },
  ...
  logAdmin: {
    eyebrow: "Log admin",
    title: "Audit log e decisioni operative.",
    lead: "Qui si spiega come leggere e usare i log admin. La pagina non espone righe reali e non mostra UUID o email utenti.",
    cards: [
      { label: "Audit", title: "Ogni azione importante lascia traccia", text: "Ruoli, permessi, owner, admin temporanei e Premium manuale devono avere audit log.", actions: [{ label: "Admin", href: "#/admin" }] },
      { label: "Queue", title: "Notifiche pending", text: "Ogni cambiamento operativo deve creare una notifica verso servizioclienti. L email reale resta server-side.", actions: [{ label: "Notifiche", href: "#/notifiche" }] },
  ...
  logStats: {
    eyebrow: "Log stats",
    title: "Statistiche operative senza dati sensibili.",
    lead: "Area per preparare metriche sicure: pagine visitate, errori, stato deploy e segnali aggregati. Nessuna lettura live dal browser in questa fase.",
    cards: [
      { label: "Deploy", title: "Stato produzione", text: "Vercel Ready, build e smoke test restano indicatori fondamentali per ogni rilascio.", actions: [{ label: "Admin", href: "#/admin" }] },
      ...
      { label: "Utenti", title: "Solo aggregati", text: "Quando arriveranno clienti reali, le statistiche dovranno essere aggregate e rispettare privacy e consenso.", actions: [{ label: "Privacy", href: "#/privacy" }] },
