    ...
    <div style={{ ...chatContainer, padding: '1rem' }}>
      ...
      <div style={chatBox} className="chat-box">
        {Object.entries(messaggiPerData).map(([giorno, messaggiDelGiorno]) => (
          <div key={giorno}>
            <div style={{ textAlign: 'center', color: '#999', margin: '0.5rem 0' }}>
              ðŸ“… {giorno}
            </div>
            {messaggiDelGiorno.map((msg) => (
              <div
                ...
                style={{
                  ...
                  backgroundColor: premiumDestinatario
                    ? '#ffd70033'
                    : msg.mittente_id === session?.user?.id
                      ? '#1e88e5'
                      : '#333',
                  marginBottom: '0.6rem',
                  padding: '0.7rem 1rem',
                ...
                title={
                  msg.letto && msg.mittente_id === session.user.id
      ...
      <div style={inputRow}>
        ...
        />
        <button onClick={inviaMessaggio} style={sendBtn}>
          ðŸ“¤
        </button>
      </div>
    </div>
