...
export default function ProfilePage() {
  ...
  const isPremium = useMemo(
    () => (profilo?.ruolo || "").toLowerCase() === "premium",
    [profilo]
  );
  ...
  return (
    <div style={containerStyle}>
      ...
      <h2 style={titleStyle}>
        👤 Il tuo profilo {isPremium && <span style={premiumBadgeAnim} aria-label="Premium">🌟</span>}
      </h2>
...
const labelStyle = { display: "block", marginTop: "0.6rem", marginBottom: "0.2rem", opacity: 0.85, fontSize: "0.95rem" };
const inputStyle = {
  display: "block", width: "100%", margin: "0.4rem 0 0.8rem",
  padding: "0.8rem", borderRadius: "8px", border: "none", backgroundColor: "#1e1e1e", color: "#fff", fontSize: "1.05rem",
};
const premiumBadgeAnim = { display: "inline-block", marginLeft: 8, animation: "shimmer 2s infinite" };
const paywallBtn = {
  backgroundColor: "#f08fc0", color: "#fff", padding: "0.7rem 1.4rem", border: "none",
  borderRadius: 6, fontWeight: "bold", fontSize: "1rem", cursor: "pointer", margin: "0.6rem 0 1.2rem",
  boxShadow: "0 0 10px #f08fc0",
};
const saveBtn = {
  backgroundColor: "#1e88e5", color: "#fff", border: "none", padding: "0.85rem 1.6rem",
  fontSize: "1rem", borderRadius: 8, fontWeight: "bold", marginTop: "1rem", cursor: "pointer",
};
