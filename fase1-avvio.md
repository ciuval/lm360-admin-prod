...
import '../styles/a11y.css'; // ✅ Import stile accessibilità
  ...
  return (
    <>
      ...
      <div style={{
        ...
        🚀 LoveMatch360 è ora online! Scopri i nuovi match perfetti!
      </div>
      ...
      <div style={{
        ...
        <header>
          ...
          <p style={{ fontSize: '1.2rem', marginBottom: '1rem' }}>
            Iscriviti gratis, completa il tuo profilo e inizia a ricevere 
match a 100/100.
          </p>
          <button
